    ...
    public static void kasMain(){
        ...
        while(kasJalan){
            ...
            switch(pilihanK) {
				...
				case 3:
					Console.Clear();
					Console.WriteLine("3 > Ubah judul kas");
					Console.Write("Judul kas: ");
					string judulVal = Console.ReadLine();
					kas.judul=judulVal;
					Console.WriteLine("Berhasil mengganti judul!");
				...
				case 4:
					Console.Clear();
					Console.WriteLine("4 > Ubah admin kas");
					Console.Write("Admin kas: ");
					string penulisVal = Console.ReadLine();
					kas.penulis=penulisVal;
					Console.WriteLine("Berhasil mengganti nama penulis!");
					wait();
					break;
                case 5:
...
public class Kas : Buku
{
    ...
    public void setSaldo(int saldoVal){
        saldo = saldoVal;
    }
	...
	public override void mainMenu()
	{
		...
		Console.WriteLine("3 > Ubah judul kas");
		Console.WriteLine("4 > Ubah admin kas");
        Console.WriteLine("5 > Informasi catatan kas");
